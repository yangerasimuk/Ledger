...
- (BOOL)isEqual:(id)object {
	...
	if (self.valueFloat != otherValue.valueFloat)
		return NO;
	if (![self.uuid isEqual:otherValue.uuid])
		return NO;
...
- (NSString *)description
{
	...
	return [NSString stringWithFormat:@"ReportValue RowId:%ld, type:%@, parameterId:%ld, value:%@, uuid:%@",
			(long)_rowId,
...
- (nonnull id)copyWithZone:(nullable NSZone *)zone {
	YYGReportValue *newValue = [[YYGReportValue alloc] initWithRowId:_rowId
																type:_type
