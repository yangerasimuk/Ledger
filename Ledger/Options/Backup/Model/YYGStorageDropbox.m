...
//                 NSLog(@"meta: %@", meta);
             ...
             NSString *fileName = [YYGStorage backupFileNameFrom:p_remoteFileNames];
...
- (void)restore {
    ...
    [self restoreRemoteFile:p_remoteFileName successHandler:^(void) {
        ...
        NSString *configFile = [NSString stringWithFormat:@"%@.config.xml", [p_remoteFileName substringToIndex:[p_remoteFileName length]-10]];
          ...
          if (result) {
              ...
              switch (taskType) {
                  case YYGDownloadTaskTypeInfo:
                      ...
                      p_backupInfo = [YYGStorage backupInfoFrom:[destinationUrl absoluteString]];
