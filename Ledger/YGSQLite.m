...
- (void)addTestOperations {
    ...
    NSArray *operations = @[
                            ...
                            @[ // бензин
                                ...
                                @22,         // target_id = expenseCategory продукты
                                @1000.00,           // source_sum =
                                @1,             // source_currency_id = 1
                                @1000.00,               // target_sum
                                @1,           // target_currency_id = 1
                            ...
                            @[ // прием у ветеринара
                                @2,         // operation_type_id = expense
                                @2,         // source_id = account Кошелек Маша
                                @17,         // target_id = expenseCategory Кошки
                            ...
                            @[ // продукты
                                @2,         // operation_type_id = expense
                                @2,         // source_id = account Кошелек Маша
                                @8,         // target_id = expenseCategory продукты
                                @630.00,           // source_sum =
                                @1,             // source_currency_id = 1
                                @630.00,               // target_sum =
                                @1,           // target_currency_id = 1
                            ...
                            @[ // электроэнергия
                                @2,         // operation_type_id = expense
                                @3,         // source_id = account Карта Сбербанк
                                @10,         // target_id = expenseCategory Дом
                                @901.24,           // source_sum
                                @1,             // source_currency_id = 1
                                @901.24,               // target_sum
                                @1,           // target_currency_id = 1
                            ...
                            @[ // одежда тасе
                                @2,         // operation_type_id = expense
                                @2,         // source_id = account Кошелек Маша
                                @18,         // target_id = expenseCategory продукты
